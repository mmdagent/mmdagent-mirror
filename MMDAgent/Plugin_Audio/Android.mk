...
LOCAL_SRC_FILES        := Plugin_Audio.cpp \
                          Audio_Manager.cpp \
                          Audio_Thread.cpp
LOCAL_LDLIBS           := -lmediandk -landroid -lEGL -lGLESv1_CM -lOpenSLES
LOCAL_STATIC_LIBRARIES := MMDAgent MMDFiles Bullet_Physics JPEG libpng zlib GLFW GLee FreeType PortAudio
